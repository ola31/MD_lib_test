...
//////////////////////////////////////////////////////////
////  터틀봇3의turtlebot3_sensor.cpp에서 클래스명 만 수정함  ///
////  ( Turtlebot3Sensor->DrokMdSensor )               ///
//////////////////////////////////////////////////////////
#include "md_can_sensor.h"

DrokMdSensor::DrokMdSensor()
{
}
...
void DrokMdSensor::initIMU(void)
{
  imu_.begin();
}

void DrokMdSensor::updateIMU(void)
{
  imu_.update();
}

void DrokMdSensor::calibrationGyro()
{
  uint32_t pre_time;
  uint32_t t_time;
...
sensor_msgs::Imu DrokMdSensor::getIMU(void)
{
...
float* DrokMdSensor::getOrientation(void)
{
...
sensor_msgs::MagneticField DrokMdSensor::getMag(void)
{
...
float DrokMdSensor::checkVoltage(void)
{
  float vol_value;
...
uint8_t DrokMdSensor::checkPushButton(void)
{
  return getPushButton();
}

void DrokMdSensor::melody(uint16_t* note, uint8_t note_num, uint8_t* durations)
{
...
void DrokMdSensor::makeSound(uint8_t index)
{
...
void DrokMdSensor::initBumper(void)
{
  ollo_.begin(3, TOUCH_SENSOR);
  ollo_.begin(4, TOUCH_SENSOR);
}

uint8_t DrokMdSensor::checkPushBumper(void)
{
...
void DrokMdSensor::initIR(void)
{
  ollo_.begin(2, IR_SENSOR);
}

float DrokMdSensor::getIRsensorData(void)
{
...
void DrokMdSensor::initSonar(void)
{
...
void DrokMdSensor::updateSonar(uint32_t t)
{
...
float DrokMdSensor::getSonarData(void)
{
  float distance = 0.0;
...
float DrokMdSensor::getIlluminationData(void)
{
  uint16_t light;
...
void DrokMdSensor::initLED(void)
{
...
void DrokMdSensor::setLedPattern(double linear_vel, double angular_vel)
{
